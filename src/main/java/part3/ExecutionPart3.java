...
public class ExecutionPart3 {
    ...
    public static void main(String[] args) {
        ...
        Estado estadoParaAdicionar = new Estado("Pernambuco", "PE");
        entityManager.persist(estadoParaAdicionar);
        entityManager.persist(new Estado("Ceara", "CE"));
        entityManager.persist(new Aluno("Ramon", 29, estadoParaAdicionar));
...
//                .getResultList();
         ...
         //Trazendo uma lista como resultado
//        String jpqlList = "select a from Aluno a where a.estado.id = :estadoId";
//        List<Aluno> alunoJPQLList = entityManager
//                .createQuery(jpqlList, Aluno.class)
...
//        alunoJPQLList.forEach(Aluno -> System.out.println("Consulta alunoJPQLList por Estado: " + Aluno));
